...
int main(int argc, char** argv) {
    ...
    double weight_TT, weight_TT_err,weight_DY, weight_DY_err, weight_time;
    ...
    out_tree->Branch("weight_time", &weight_time);
    ...
    while (myReader.Next()) {
        ...
        weight_time = std::chrono::duration_cast<milliseconds>(end_time - start_time).count();
        ...
        LOG(info) << "Weight computed in " << weight_time << "ms";
